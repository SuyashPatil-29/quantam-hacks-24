...
export const RichTextComponents = {
    ...
    block: {
        h1: ({children} :any) => <h1 className="py-10 text-3xl font-bold md:text-3xl text-pink-700 ">{children}</h1>,
        h2: ({children} :any) => <h2 className="py-10 text-3xl font-bold md:text-3xl text-pink-700 ">{children}</h2>,

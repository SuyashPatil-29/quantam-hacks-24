...
const HomePageCard = (props :any) => {
    return (
        ...
        <div className="bg-white border-gray-200 dark:bg-transparent border-2 dark:border-gray-300 rounded-3xl hover:transform hover:scale-105 dark:shadow-none shadow-2xl transition-all duration-500 min-h-[350px] relative">
            <img className=" rounded-t-3xl h-[200px] object-cover w-[400px]" src={props.image} alt="home" />
        <div className="p-5">

...
const HomePageFooter = () => {
    return (
        <div className='md:flex-row flex-col md:gamd:p-6 p-3 gap-3 lg:mx-[150px] md:mx-[100px] mx-3 flex'>
            <Link href="/contact" className='h-[250px] flex flex-col group justify-center gap-4 border border-[#F7AB0A]/25 md:mt-8 text-card-foreground shadow-sm bg-[rgb(16,16,16)] md:p-6 p-3 rounded-3xl md:w-[65%] w-full md:mb-20'>

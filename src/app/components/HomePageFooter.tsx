...
const HomePageFooter = () => {
    return (
        <div className='flex gap-10 lg:mx-[150px] md:mx-[100px]'>
            <Link href="/blogs" className='h-[250px] flex flex-col group justify-center gap-4 border border-[#F7AB0A]/25 mt-8 text-card-foreground shadow-sm bg-[rgb(16,16,16)] p-6 rounded-3xl w-[65%] mb-20'>

...
const HomePageFooter = () => {
    return (
        <div className='md:flex-row flex-col md:gap-6 gap-3 lg:mx-[150px] md:mx-[100px] mx-3 flex'>
            <Link href="/contact" className='h-[250px] flex flex-col group justify-center gap-4 border border-[#F7AB0A]/25 md:mt-8 text-card-foreground shadow-sm bg-[rgb(16,16,16)] p-6 rounded-3xl md:w-[65%] w-full md:mb-20'>
            ...
            <div className='h-[250px] border flex gap-4 justify-evenly items-center border-[#F7AB0A]/25 md:mt-8 text-card-foreground shadow-sm bg-[rgb(16,16,16)] md:w-[35%] w-full p-6 rounded-3xl md:mb-20 mb-10'>

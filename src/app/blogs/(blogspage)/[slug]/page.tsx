  ...
  return (
    <div  className='lg:mx-[262px] min-h-screen'>
      ...
      <div>
          ...
          <h1 className="lg:text-[48px] text-3xl  font-bold text-white grid place-content-center lg:mx-0 mx-auto mt-5">{post.title}</h1>
      </div>
      ...
      <article className="lg:mx-0 md:mx-[30px] mx-4">
        ...
        <ScrollToTop />
      <footer>
                <div className= " my-10 justify-end text-green-400  flex hover:opacity-80">
                  <Link href="/blogs" as={"/blogs"} className="inline-flex items-center px-3 lg:py-2 pr-5 text-md font-medium text-center">
